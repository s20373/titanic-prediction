...
def main():
    st.set_page_config(page_title="Sprawdź kto przeżyłby katastrofę Titanic")
    overview = st.container()
    left, right = st.columns(2)
    prediction = st.container()

    st.image("https://images.hindustantimes.com/img/2022/07/11/550x309/pothole_meme_titanic_1657546212551_1657546532162_1657546532162.jpg")

    with overview:
        st.title("Sprawdź jaka osoba przeżyłaby katastrofę Titanic")
